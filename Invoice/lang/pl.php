<?php
$translations['Premium_Warehouse_Invoice']['Purchase Order no.'] = 'Proforma nr.';
$translations['Premium_Warehouse_Invoice']['Receipt no.'] = 'Paragon nr.';
$translations['Premium_Warehouse_Invoice']['Invoice no.'] = 'Faktura VAT nr.';
$translations['Premium_Warehouse_Invoice']['Order no.'] = 'Zamówienie';
$translations['Premium_Warehouse_Invoice']['ORIGINAL | COPY'] = 'ORYGINAL | KOPIA | DUPLIKAT';
...
$translations['Premium_Warehouse_Invoice']['Sold to:'] = 'Nabywca:';
$translations['Premium_Warehouse_Invoice']['Address:'] = 'Adres:';
$translations['Premium_Warehouse_Invoice']['SSN:'] = 'Numer indentyf.:';
...
$translations['Premium_Warehouse_Invoice']['units'] = 'jm';
$translations['Premium_Warehouse_Invoice']['Net price'] = 'Cena netto';
$translations['Premium_Warehouse_Invoice']['Tax rate'] = 'Stawka VAT %%';
$translations['Premium_Warehouse_Invoice']['Gross value'] = 'Wartosc brutto';
$translations['Premium_Warehouse_Invoice']['Net value'] = 'Wartosc netto';
$translations['Premium_Warehouse_Invoice']['Tax value'] = 'Wartosc VAT';

$translations['Premium_Warehouse_Invoice']['AMOUNT DUE:'] = 'DO ZAPLATY:';
$translations['Premium_Warehouse_Invoice']['IN WORDS:'] = 'SLOWNIE:';
$translations['Premium_Warehouse_Invoice']['Receiver signature'] = 'Podpis osoby upowaznionej<br/>do odbioru faktury VAT';
