...
class UploadPostHelper {
		 ...
		 */
		public static function getPostData(fileName:String, byteArray:ByteArray, uploadDataFieldName:String = "filedata", parameters:Dynamic = null):ByteArray {
			...
			Reflect.setField(parameters,"Filename",fileName);
		...
		private static function BOUNDARY(p:ByteArray):ByteArray {
			var l = UploadPostHelper.getBoundary().length;
