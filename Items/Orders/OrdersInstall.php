...
class Premium_Warehouse_Items_OrdersInstall extends ModuleInstall {
	...
	public function install() {
		...
		$fields = array(
			...
			array('name'=>'Target Warehouse','type'=>'select', 'required'=>true, 'extra'=>false, 'visible'=>true, 'param'=>'premium_warehouse::Warehouse;::', 'extra'=>false, 'visible'=>true, 'display_callback'=>array('Premium_Warehouse_Items_OrdersCommon', 'display_warehouse')),
			...
			array('name'=>'Shipment ETA',	'type'=>'text', 'param'=>'128', 'required'=>false, 'extra'=>false, 'visible'=>false),
			...
			array('name'=>'Tracking Info',	'type'=>'date', 'required'=>false, 'extra'=>false, 'visible'=>false),
...
//			array('name'=>'Serial',				'type'=>'text', 'required'=>false, 'param'=>'128', 'extra'=>false, 'visible'=>true, 'QFfield_callback'=>array('Premium_Warehouse_Items_OrdersCommon', 'QFfield_serial'), 'display_callback'=>array('Premium_Warehouse_Items_OrdersCommon', 'display_serial')),
			...
			array('name'=>'Tax Rate', 			'type'=>'select', 'required'=>true, 'extra'=>false, 'visible'=>true, 'param'=>'__COMMON__::Premium_Warehouse_Items_Tax', 'QFfield_callback'=>array('Premium_Warehouse_Items_OrdersCommon', 'QFfield_details_tax_rate')),
...
// ************ other ************** //
		...
		Utils_CommonDataCommon::new_array('Premium_Items_Orders_Trans_Types',array(0=>'Purchase',1=>'Sale',2=>'Inventory Adjustment',3=>'Rental',3=>'Warehouse Transfer'));
