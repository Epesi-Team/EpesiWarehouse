...
class Premium_Warehouse_Items_Orders_Printer extends Base_Print_Printer {
    ...
    protected function print_document($order)
    {
        $this->section_header();
    ...
    protected function section_top()
    {
        ...
        $section->assign('date', $order['transaction_date']);
    ...
    protected function section_bottom()
    {
        ...
        if (!$order['receipt']) {
            ...
            $labels['employee_sig'] = __('Employee signature');
        }
    ...
    {
        $ret = array();
        $p = 'Premium/Warehouse/Items/Orders/';
        $available_templates = array('simple');
