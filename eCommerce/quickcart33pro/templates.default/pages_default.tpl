...
<!-- END PRODUCTS_LIST -->
<!-- BEGIN PRODUCTS_PRICE --><div class="price"><em>$lang[Price]:</em><strong>$config[currency_symbol]&nbsp;$aData[sPrice]</strong></div><!-- END PRODUCTS_PRICE -->
...
<div style="padding: 7px 0;border-bottom: 1px solid white;background-color: transparent;color: #ED1C24;font-size: 1.417em;font-weight: bold;text-align: center;">Out of stock</div>
