...
<!-- BEGIN LIST_BASKET --><li class="l$aData[sStyle]" id="basketMenu"><a href="$aData[sLinkName]" $aData[sSelected]>$aData[sName]</a><span>$lang[Basket_products]:&nbsp;<strong>$iOrderProducts</strong><br />$lang[Summary]:&nbsp;<strong>$fOrderSummary $config[currency_symbol]</strong></span>$aData[sSubContent]</li><!-- END LIST_BASKET -->
