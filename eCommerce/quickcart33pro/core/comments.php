...
*/
function addComment( $aForm, $iLink, $isProduct = false){
  //{ epesi
  //TODO: to jest domyslnie wykonywana kwarenda dla produktow, trzeba zrobic ifa i kwarende dla stron
...
* @param  int     $iLink
*/
function listComments( $sFile, $iLink, $isProduct = false){
  ...
  //} epesi
      ...
      $aData['sLink'] = (!$isProduct) ? 'iPage' : 'iProduct';
      $aData['sPage'] = (!$isProduct) ? 'p' : 'products';
