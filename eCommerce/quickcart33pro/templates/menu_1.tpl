...
<!-- BEGIN LIST_LANG --><li class="l$aData[sStyle]" id="langMenu"><a href="$aData[sLinkName]" $aData[sSelected]>$aData[sName]</a></li><!-- END LIST_LANG -->
<!-- BEGIN HEAD_LANG --><li id="langMenu"><a onclick="showLang()">$aData[sName]</a></li><div id="lang"><!-- END HEAD_LANG -->
<!-- BEGIN FOOT_LANG --><li></li></div><!-- END FOOT_LANG -->
