...
<!-- END PRODUCTS_LIST -->
<!-- BEGIN PRODUCTS_PRICE --><div class="price"><em>$lang[Price]:</em><strong>$aData[sPrice]</strong><span>$config[currency_symbol]</span><br />$lang['Product_available']: $aData[sAvailable]</div><!-- END PRODUCTS_PRICE -->
