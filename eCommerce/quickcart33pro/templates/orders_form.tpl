      ...
      <fieldset id="personalData">
        ...
        <fieldset id="setExtend">
          ...
          <div id="password2">
            ...
            <input type="password" name="sPassword2" value="" maxlength="100" class="input" onblur="saveUserData( this.name, this.value )" id="oPassword2" alt="txtValue;#oPassword;$lang[Password_mismatch];if" />
          </div>
