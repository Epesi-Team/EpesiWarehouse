  ...
  <fieldset id="type2">
    ...
    <table cellspacing="1" class="mainTable" id="payment">
      ...
      <tbody>
        ...
        <tr class="l1">
          <th>$lang[Relate_with]</th>
          <td><select name="iOuterSystem"><option value="">$lang['none']</option>$sOuterPaymentOption</select></td>
        </tr>
        <tr class="l0">
...
<tr>
  ...
  <td>
    <input type="text" name="aCarriersPrices[$aData[iCarrier]]" value="$aData[sPrice]" class="inputr$aData[sDisable]" size="30" id="oCarrier$aData[iCarrier]" />
