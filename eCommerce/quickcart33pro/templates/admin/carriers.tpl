  ...
  <fieldset id="type2">
    ...
    <table cellspacing="1" class="mainTable" id="carrier">
      ...
      <tr class="l0">
        ...
        <td rowspan="4" class="tabs">$sFormTabs</td>
      </tr>
      <!-- name end -->
      <!-- price start -->
      <tr class="l1">
        ...
        <td>
          <input type="text" name="fPrice" value="$aData[fPrice]" class="input" size="30" alt="simple" /> $lang[Price_range_example]
        </td>
      </tr>
      <!-- price end -->
      ...
      <tr class="l0">
        ...
        <td>
          <input type="text" name="sWeightRange" value="$aData[sWeightRange]" class="input" size="30" /> $lang[Weight_range_example]
        </td>
      </tr>
      <!-- weight end -->
      <tr class="end">
...
<tr>
  ...
  <td>
    <input type="text" name="aPaymentsPrices[$aData[iPayment]]" value="$aData[sPrice]" class="inputr$aData[sDisable]" size="30" id="oPayment$aData[iPayment]" />
    $lang[example] -10;20;100%
  </td>
</tr>
<!-- END PAYMENT_LIST -->
