...
class Premium_Warehouse_DrupalCommerce_CurrencyUpdatePricesInstall extends ModuleInstall {
	...
	public function requires($v) {
		return array(
			array('name'=>'Premium/Warehouse/DrupalCommerce','version'=>0),
	...
	public static function simple_setup() {
        return array('package'=>__('DrupalCommerce'));
	}
