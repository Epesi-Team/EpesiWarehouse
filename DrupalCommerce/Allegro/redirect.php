...
$auctions = Premium_Warehouse_DrupalCommerce_AllegroCommon::get_other_auctions($_GET['id']);
...
if(Base_User_SettingsCommon::get('Premium_Warehouse_DrupalCommerce_Allegro','country')==228)
