...
class Premium_Warehouse_DrupalCommerce_AllegroCommon extends ModuleCommon {
	...
	if(!isset($r['id']))
        ...
        if (!$x || !Base_User_SettingsCommon::get('Premium_Warehouse_DrupalCommerce_Allegro','login')) return array('show'=>false);
    ...
    public static function get_lib() {
    	...
    	if($a===null) {
    		...
    		$a = new Allegro(Base_User_SettingsCommon::get('Premium_Warehouse_DrupalCommerce_Allegro','login'),
    			Base_User_SettingsCommon::get('Premium_Warehouse_DrupalCommerce_Allegro','pass'),
    			Base_User_SettingsCommon::get('Premium_Warehouse_DrupalCommerce_Allegro','country'),
    			Base_User_SettingsCommon::get('Premium_Warehouse_DrupalCommerce_Allegro','key'));
